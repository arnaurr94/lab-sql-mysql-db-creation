...
insert into customers (customer_id, `name`, phone, address, city, `state`, country, ZIP_code)
...
('30001', 'Napoléon Bonaparte',	'+33179754000', '40 Rue du Colisée	Paris',	'Paris', 'Île-de-France',	'France',	'75008');
